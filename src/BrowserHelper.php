...
/**
 * uncomment and specify is you wanna use this otherwise just use require_once
 */
...
class BrowserHelper
{
    ...
    private function _get_browser(){
        ...
        $this->_known = array('Version', $this->_user_browser, 'other');
        ...
        if ($this->_i != 1):
            if (strripos($this->_user_agent,"Version") < strripos($this->_user_agent,$this->_user_browser)):
                $this->_version= $this->_matches['version'][0];
            else:
                $this->_version= $this->_matches['version'][1];
            endif;
        else:
            $this->_version= $this->_matches['version'][0];
        endif;

        if ($this->_version==null || $this->_version=="")$this->_version="?";
    ...
    public function IsVersion($_comparison, $is_version){
        ...
        if($this->getIsUserBrowser() === true):
            if($this->_comparisons[0] === $this->_comparison):
                if($this->_get_browser()['version'] == $this->_is_version):
                    $this->_version_comparison = true;
                else:
                    $this->_version_comparison = false;
                endif;
        ...
        return $this->_version_comparison;
    }
}
